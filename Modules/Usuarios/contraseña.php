...
<div class="row">
    ...
    <div class="card card-body">
        <form action="modifica_con.php" method="post">
        ...
        <div class="col-md-4">
            ...
            <div class="col-md-4">
            <input type="text" name="nom" class="form-control" value="<?php echo $datos['nombre'];?>"readonly >
        </div>
        <div class="col-md-4">Telefono:</div>
        <div class="col-md-4">
            <input type="text" name="tel" class="form-control" value="<?php echo $datos['telefono'];?>"readonly>
            </div>
            <div class="col-md-4">Usuario:</div>
            <div class="col-md-4">
            <input type="text" name="user" class="form-control" value="<?php echo $datos['Usuario'];?>"readonly>
            </div>
            <div class="col-md-4">Contraseña:</div>
            <div class="col-md-4">
            <input type="text" name="pass" class="form-control" value="" autofocus>
            </div>
            <div class="col-md-4">
